  ...
  return (
    ...
    >
      <motion.div
        ...
        className="min-h-0 w-full max-w-xl shrink overflow-hidden rounded-2xl shadow-sm lg:max-w-3xl"
      >
        <img
          ...
          className="mx-auto h-auto max-h-[clamp(72px,22vh,220px)] w-auto max-w-full object-contain lg:max-h-[clamp(140px,26vh,260px)]"
        />
      </motion.div>

      <div className="flex w-full max-w-xl shrink flex-col items-center gap-[clamp(0.75rem,2.4vh,2rem)] lg:max-w-4xl lg:flex-row lg:items-center lg:justify-center lg:gap-12 xl:gap-16">
        <div className="min-h-0 shrink-0 text-center lg:flex-1 lg:text-left">
          <motion.h1
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, ease: 'easeOut' }}
            className="text-[clamp(1.1rem,3.2vh,2.25rem)] font-bold leading-tight text-hdfc-navy lg:text-[clamp(1.5rem,4.2vh,3rem)]"
          >
            My Golden Era Link Portal
          </motion.h1>
          <div className="mx-auto mt-[clamp(0.25rem,0.8vh,0.75rem)] h-1 w-16 bg-hdfc-red lg:mx-0" />
          <motion.p
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.1, duration: 0.5 }}
            className="mx-auto mt-[clamp(0.25rem,1vh,1rem)] max-w-xl text-[clamp(0.7rem,1.7vh,1rem)] text-slate-600 lg:mx-0 lg:max-w-md lg:text-[clamp(0.9rem,2vh,1.15rem)]"
          >
        ...
        <motion.div
          ...
          whileHover={{ y: -4 }}
          className="flex w-full max-w-xs shrink flex-col items-center justify-center rounded-lg border border-slate-200 bg-white p-[clamp(0.75rem,2.4vh,2rem)] text-center transition-shadow hover:shadow-lg sm:max-w-sm lg:max-w-sm lg:shrink-0"
        >
          <motion.span
